        ...
        <div className=" h-100 p-0">
            <section className="flex items-center justify-between mx-4 pt-6 ">
                ...
                <div className="flex items-center text-sm hover:cursor-pointer">
                    <h2 className="mr-4 hover:text-gray-500">
                        Filter
                        <img src="/assets/icon-arrow-down.svg" className="inline-block ml-2" />
                    </h2>
                    <h2 className="bg-purple p-2  rounded-full  hover:cursor-pointer hover:bg-violet-700  text-white">
                        <img src="/assets/icon-plus.svg" className="inline-block bg-white p-2 rounded-full mr-2" />
                        New
                    </h2>
                </div>
            </section>
            ...
            <section className="mx-auto mt-20 w-4/5 text-center">
                <img src="/assets/illustration-empty.svg" className="w-100 mx-auto" />
